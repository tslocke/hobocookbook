...
gem "hobo_fields", :path => "/work/hobo"
gem "dryml", :path => "/work/hobo"
gem "hobo", :path => "/work/hobo"
gem "hobo_rapid", :path => "/work/hobo"
gem "hobo_clean", :path => "/work/hobo"
gem "hobo_clean_admin", :path => "/work/hobo"
gem "hobo_jquery", :path => "/work/hobo"
gem "hobo_jquery_ui", :path => "/work/hobo"
