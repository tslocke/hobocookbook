...
#  TAGLIB_HOME = "#{Rails.root}/vendor/hobo13/hobo/lib/hobo/rapid/taglibs"
  ...
  def self.load
    ...
    [Dryml,HoboRapid,HoboJquery,HoboJqueryUi,HoboClean,HoboCleanSidemenu,HoboBootstrap,HoboPaperclip,HoboDataTables,HoboTokeninput,HoboSimpleColor,HoboTreeTable,HoboMapstraction,SelectOneOrNewDialog].each_with_index do |mod, position|
